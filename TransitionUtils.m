classdef TransitionUtils
    ...
    methods(Static)
        ...
        function M = animate_bifurcated_soln(beta, eta, period, m, dt, T, u, gal_m, h20, gal_2m, h11, gal_0, flag, u0_)
            ...
            %u0 = u0_(z_);
            ax = [0 period gal_m.x_fun(-1) gal_m.x_fun(1)];
            N = ceil(T/dt);
        ...
        function lambda_c = critical_lambda(initializer, m, param, lambda_name, lambda_l, lambda_r, MaxIter, pol)
