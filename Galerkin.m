                ...
                switch obj.ord(i)
                    case 4
                        ...
                        for p=0:pol.N-4
                            for j=1:4
                                A(1,j)=bc_l{i}{1}(...
                                    pol.P(p+1+j,1),...
                                    obj.sc*pol.dP(p+1+j,1),...
                                    obj.sc^2*pol.d2P(p+1+j,1),...
                                    obj.sc^3*pol.d3P(p+1+j,1) );
                                A(2,j)=bc_l{i}{2}(...
                                    pol.P(p+1+j,1),...
                                    obj.sc*pol.dP(p+1+j,1),...
                                    obj.sc^2*pol.d2P(p+1+j,1),...
                                ...
                                A(3,j)=bc_r{i}{1}(...
                                    pol.P(p+1+j,end),...
                                    obj.sc*pol.dP(p+1+j,end),...
                                    obj.sc^2*pol.d2P(p+1+j,end),...
                                    obj.sc^3*pol.d3P(p+1+j,end) );
                                A(4,j)=bc_r{i}{2}(...
                                    pol.P(p+1+j,end),...
                                    obj.sc*pol.dP(p+1+j,end),...
                                    obj.sc^2*pol.d2P(p+1+j,end),...
                            ...
                            A0(1)=bc_l{i}{1}(...
                                pol.P(p+1,1),...
                                obj.sc*pol.dP(p+1,1),...
                                obj.sc^2*pol.d2P(p+1,1),...
                                obj.sc^3*pol.d3P(p+1,1) );
                            A0(2)=bc_l{i}{2}(...
                                pol.P(p+1,1),...
                                obj.sc*pol.dP(p+1,1),...
                                obj.sc^2*pol.d2P(p+1,1),...
                            ...
                            A0(3)=bc_r{i}{1}(...
                                pol.P(p+1,end),...
                                obj.sc*pol.dP(p+1,end),...
                                obj.sc^2*pol.d2P(p+1,end),...
                                obj.sc^3*pol.d3P(p+1,end) );
                            A0(4)=bc_r{i}{2}(...
                                pol.P(p+1,end),...
                                obj.sc*pol.dP(p+1,end),...
                                obj.sc^2*pol.d2P(p+1,end),...
                    ...
                    case 2
                        ...
                        for p=0:pol.N-2
                            for j=1:2
                                A(1,j)=bc_l{i}{1}(...
                                    pol.P(p+1+j,1),obj.sc*pol.dP(p+1+j,1));
                                A(2,j)=bc_r{i}{1}(...
                                    pol.P(p+1+j,end),obj.sc*pol.dP(p+1+j,end));
                            end
                            A0(1)=bc_l{i}{1}(...
                                pol.P(p+1,1),obj.sc*pol.dP(p+1,1));
                            A0(2)=bc_r{i}{1}(...
                                pol.P(p+1,end),obj.sc*pol.dP(p+1,end));
                            c_(p+1,:)=-(A\A0)';
                        end
                    otherwise
